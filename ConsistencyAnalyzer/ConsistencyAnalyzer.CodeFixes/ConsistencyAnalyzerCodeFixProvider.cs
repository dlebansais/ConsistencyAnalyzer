...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ConsistencyAnalyzerCodeFixProvider)), Shared]
    public class ConsistencyAnalyzerCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(ConsistencyAnalyzerAnalyzer.DiagnosticId); }
        }
