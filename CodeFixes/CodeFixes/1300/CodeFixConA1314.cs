namespace ConsistencyAnalyzer
{
    ...
    public class CodeFixConA1314 : CodeFix
    {
        ...
        private async Task<Document> AsyncHandler(Document document, VariableDeclaratorSyntax syntaxNode, CancellationToken cancellationToken, string newValueText)
        {
            ...
            Analyzer.Trace("CodeFixConA1314", TraceLevel);
        ...
        public override CodeAction? CreateDocumentHandler(CodeFixContext context, SyntaxNode root, TextSpan diagnosticSpan)
        {
            ...
            string NewValueText = NameExplorer.FixName(ValueText, NameCategory.LocalVariable);

            string CodeFixMessageFormat = new LocalizableResourceString(nameof(CodeFixResources.ConA1314FixTitle), CodeFixResources.ResourceManager, typeof(CodeFixResources)).ToString();
            ...
            var Action = CodeAction.Create(title: FormatedMessage,
                    ...
                    equivalenceKey: nameof(CodeFixResources.ConA1314FixTitle));
