namespace ConsistencyAnalyzer
{
    ...
    public class CodeFixConA1309 : CodeFix
    {
        ...
        private async Task<Document> AsyncHandler(Document document, VariableDeclaratorSyntax syntaxNode, CancellationToken cancellationToken, string newValueText)
        {
            ...
            Analyzer.Trace("CodeFixConA1309", TraceLevel);
        ...
        public override CodeAction? CreateDocumentHandler(CodeFixContext context, SyntaxNode root, TextSpan diagnosticSpan)
        {
            ...
            string NewValueText = NameExplorer.FixName(ValueText, NameCategory.Field);

            string CodeFixMessageFormat = new LocalizableResourceString(nameof(CodeFixResources.ConA1309FixTitle), CodeFixResources.ResourceManager, typeof(CodeFixResources)).ToString();
            ...
            var Action = CodeAction.Create(title: FormatedMessage,
                    ...
                    equivalenceKey: nameof(CodeFixResources.ConA1309FixTitle));
