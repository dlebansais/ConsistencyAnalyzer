...
namespace StyleCop.Analyzers.Helpers
{
    ...
    internal static class UsingDirectiveSyntaxHelpers
    {
        ...
        /// <param name="systemUsingDirectivesFirst">The setting that will be used.</param>
        /// <returns>The <see cref="UsingGroup"/> for the given <paramref name="usingDirective"/>.</returns>
        internal static UsingGroup GetUsingGroupType(this UsingDirectiveSyntax usingDirective, bool systemUsingDirectivesFirst)
        {
