namespace ConsistencyAnalyzer
{
    ...
    /// </summary>
    public class AnalyzerRuleConA1311 : SingleSyntaxAnalyzerRule
    {
        #region Properties
        /// <summary>
        /// Gets the rule id.
        /// </summary>
        public override string Id { get; } = ToRuleId(nameof(AnalyzerRuleConA1311));
        ...
        /// Gets the rule title.
        /// </summary>
        protected override LocalizableString Title { get; } = new LocalizableResourceString(nameof(Resources.ConA1311Title), Resources.ResourceManager, typeof(Resources));

        /// <summary>
        /// Gets the rule message format.
        /// </summary>
        protected override LocalizableString MessageFormat { get; } = new LocalizableResourceString(nameof(Resources.ConA1311MessageFormat), Resources.ResourceManager, typeof(Resources));

        /// <summary>
        /// Gets the rule description.
        /// </summary>
        protected override LocalizableString Description { get; } = new LocalizableResourceString(nameof(Resources.ConA1311Description), Resources.ResourceManager, typeof(Resources));
        ...
        public override void AnalyzeNode(SyntaxNodeAnalysisContext context)
        {
            ...
            Analyzer.Trace("AnalyzerRuleConA1311", TraceLevel);
            ...
            try
            {
                ...
                if (!Explorer.IsNameMismatch(ValueText, NameCategory.Method, out NamingSchemes ExpectedSheme, TraceLevel))
                    return;
